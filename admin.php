		...
		<div id="ms">
			<div id="lf" style="float:left;">
				<div id="menuput" class="dbor">
					...
					<a style="color:#000; font-size:13px; text-decoration:none;" href="?do=milestone">
						<div class="mainmu">
							經歷管理 </div>
						</a>
					<a style="color:#000; font-size:13px; text-decoration:none;" href="?do=gallery">
						<div class="mainmu">
							作品資料管理 </div>
					</a>
						<a style="color:#000; font-size:13px; text-decoration:none;" href="?do=article">
							<div class="mainmu">
								自傳管理 </div>
						</a>
